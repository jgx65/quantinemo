...
\item Chapter \hyperref[chap:GeneralParameters]{General Parameters} give details information about the parameters used for metainformation about the simulation, i.e. relevant but not modifying the scenario itself, like the folder, the number of replicate, the initial seed, etc. 
...
\begin{description}
\item[(ntrl/quanti)\_ini\_genotypes\index{quanti\_ini\_genotypes}] \textbf{[string] (default: "")}\\
...
\item[ntrl\_ini\_allele\_model\index{quanti\_ini\_allele\_model}] \textbf{[0,1] (default: 0)}\\
...
\item[(ntrl/quanti)\_genot\_age\index{quanti\_genot\_age}] \textbf{[0-2] (default: 0)}\\
