...
\item[extinction\_model\index{extinction\_model}] \textbf{[0-1] (default: 0)}  \\
...
\item[threads\index{threads}] \textbf{[integer] (default: 1)}\\
...
\item[threaded\_lce\index{threaded\_lce}] \textbf{[binary/integer] (default: 0)}\\
...
\item[all\_combinations\index{all\_combinations}] \textbf{[0-1] (default: 0)}\\
...
\begin{description} 
\item[ntrl\_save\_genotype\index{ntrl\_save\_genotype}] \textbf{[0-5] (default: 0)} \\
