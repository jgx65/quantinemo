...
private:
	...
	AlleleContainer _alleles;   // owns this individual's diploid allele block

public:
	TGenome();
	TGenome(const TGenome& T): _protoGenome(T._protoGenome), _alleles(){}
	~TGenome();
	void clear();
	...
	AlleleContainer&       alleles()       {return _alleles;}
	const AlleleContainer& alleles() const {return _alleles;}
...
protected:
	...
	void  _mutate_equal_mutation_rate_pleiotrophy(AlleleContainer& seq);
	void  _mutate_equal_mutation_rate_pleiotrophy_correl(AlleleContainer& seq);
	void  _mutate_unequal_mutation_rate(AlleleContainer& seq);
	void  _mutate_unequal_mutation_rate_pleiotrophy(AlleleContainer& seq);
	void  _mutate_unequal_mutation_rate_pleiotrophy_correl(AlleleContainer& seq);
...
public:
	...
	void inherit(TIndividual* mother, TIndividual* father, AlleleContainer& child);

	void mutate(AlleleContainer& seq);
	void ini_mutate();
	void set_mutation_of_locus(const unsigned int& l, const double& rate, const mut_model_t& model);

	void ini_sequence(AlleleContainer& seq, TPatch* patch);
